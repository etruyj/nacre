...
public class PoolConfig extends Pool {
    ...
    private int preferred_stripe_size;
    ...
    private int stripe_increment;
    @SerializedName("max_spare_drives")
    private int max_spare_drives;
    ...
    // Getters
    //===========================================
    public int getPreferredStripeSize() { return preferred_stripe_size; }
    public String getProtectionLevel() { return protection_level; }
    public String getPoolAllocation() { return pool_allocation; }
    public int getStripeIncrement() { return stripe_increment; }
    public int getMaxSpareDrives() { return max_spare_drives; }
    ...
    // Setters
    //===========================================
    public void setPreferredStripeSize(int stripe_size) { this.preferred_stripe_size = stripe_size; }
    ...
    public void setStripeIncrement(int increment) { this.stripe_increment = increment; }
    public void setMaxSpareDrives(int max) { this.max_spare_drives = max; }
